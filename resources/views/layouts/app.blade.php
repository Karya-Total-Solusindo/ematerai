...
<body onload="loader()" class="{{ $class ?? '' }}" style="margin:0; background-color: '#6c757d !important">
    ...
    <div class="modal fade" style="z-index: 999999; height: auto !important;"  id="modalLogout" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
