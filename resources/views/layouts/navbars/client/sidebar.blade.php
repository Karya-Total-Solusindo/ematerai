            ...
            <ul class="nav flex-column" id="nav_accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="submenu collapse rounded  {{ request()->segment(1) == 'configure' ? 'show' : '' }}">
                        ...
                        <li><a class="nav-link rounded {{ request()->segment(2) == 'company' ? 'active' : '' }}" href="{{ route('company.index') }}">Collector </a></li>
    ...
    <ul class="nav flex-column" id="nav_accordion">
        ...
        <li class="nav-item has-submenu">
            ...
            <ul class="submenu collapse rounded {{ request()->segment(1) == 'stemp' ? 'show' : '' }}">
                ...
                <li><a class="nav-link rounded {{ request()->segment(2) == 'failed' ? 'active' : '' }}" href="{{route('company')}}">Failed </a></li>
